...
def test_normalize_tags_output_single_words(tmp_path: Path) -> None:
...
def test_normalize_tags_output_empty(tmp_path: Path) -> None:
    output_path = tmp_path / "tags.txt"
...
def test_normalize_tags_output_dedupes_case_insensitive(tmp_path: Path) -> None:
    output_path = tmp_path / "tags.txt"
